...
import static org.opensearch.plugin.transport.grpc.proto.request.search.query.IdsQueryBuilderProtoUtils.fromProto;
...
public class IdsQueryBuilderProtoUtilsTests extends OpenSearchTestCase {
    ...
    public void testFromProtoWithAllFields() {
        ...
        IdsQuery idsQuery = IdsQuery.newBuilder()
            .setUnderscoreName("test_ids_query")
            .setBoost(1.5f)
            .addValues("doc1")
            .addValues("doc2")
            .addValues("doc3")
    ...
    public void testFromProtoWithNameOnly() {
        ...
        IdsQuery idsQuery = IdsQuery.newBuilder().setUnderscoreName("my_ids_query").build();
