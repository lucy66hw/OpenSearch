...
import static org.opensearch.plugin.transport.grpc.proto.request.search.query.BoolQueryBuilderProtoUtils.fromProto;
...
public class BoolQueryBuilderProtoUtilsTests extends OpenSearchTestCase {
    ...
    private QueryContainer createTermQueryContainer(String field, String value) {
        return QueryContainer.newBuilder()
            .setTerm(TermQuery.newBuilder().setField(field).setValue(FieldValue.newBuilder().setStringValue(value).build()).build())
            .build();
    }
