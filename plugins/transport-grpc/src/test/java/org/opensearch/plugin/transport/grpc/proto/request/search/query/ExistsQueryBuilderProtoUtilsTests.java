...
import static org.opensearch.plugin.transport.grpc.proto.request.search.query.ExistsQueryBuilderProtoUtils.fromProto;
...
public class ExistsQueryBuilderProtoUtilsTests extends OpenSearchTestCase {
    ...
    public void testFromProtoWithAllFields() {
        ...
        ExistsQuery proto = ExistsQuery.newBuilder().setField("test_field").setBoost(2.0f).setUnderscoreName("test_query").build();
