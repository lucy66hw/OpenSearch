...
public class QueryBuilderProtoTestUtils {
    ...
    public static void setupRegistry() {
        ...
        registry.registerConverter(new BoolQueryBuilderProtoConverter());
        registry.registerConverter(new MultiMatchQueryBuilderProtoConverter());
        registry.registerConverter(new RegexpQueryBuilderProtoConverter());
        registry.registerConverter(new WildcardQueryBuilderProtoConverter());
        registry.registerConverter(new ExistsQueryBuilderProtoConverter());
