...
class DecayFunctionProtoUtils {
    ...
    static org.opensearch.search.MultiValueMode parseMultiValueMode(MultiValueMode multiValueMode) {
        switch (multiValueMode) {
            case MULTI_VALUE_MODE_AVG:
                return org.opensearch.search.MultiValueMode.AVG;
            case MULTI_VALUE_MODE_MAX:
                return org.opensearch.search.MultiValueMode.MAX;
            case MULTI_VALUE_MODE_MIN:
                return org.opensearch.search.MultiValueMode.MIN;
            case MULTI_VALUE_MODE_SUM:
                return org.opensearch.search.MultiValueMode.SUM;
            default:
                throw new IllegalArgumentException("Unsupported multi value mode: " + multiValueMode);
        }
    }
}
