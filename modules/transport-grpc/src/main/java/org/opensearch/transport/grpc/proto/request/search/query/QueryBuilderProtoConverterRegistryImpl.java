...
public class QueryBuilderProtoConverterRegistryImpl implements QueryBuilderProtoConverterRegistry {
    ...
    protected void registerBuiltInConverters() {
        ...
        // Bool converter needs special handling for nested queries
        BoolQueryBuilderProtoConverter boolConverter = new BoolQueryBuilderProtoConverter();
        boolConverter.setRegistry(this);
        delegate.registerConverter(boolConverter);
