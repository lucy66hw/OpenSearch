...
public final class SearchRequestSlowLog extends SearchRequestOperationsListener {
    ...
    static final class SearchRequestSlowLogMessage extends OpenSearchLogMessage {
        ...
        private static Map<String, Object> prepareMap(
            ...
            long coordinatorQueryReduceAndFetchPlanTimeInNanos = searchRequestContext.getCoordinatorQueryReduceAndFetchPlanTimeInNanos();
            long coordinatorPostFetchTimeInNanos = searchRequestContext.getCoordinatorPostFetchTimeInNanos();
            ...
            messageFields.put(
                "coordinator_query_reduce_and_fetch_plan_millis",
                TimeUnit.NANOSECONDS.toMillis(coordinatorQueryReduceAndFetchPlanTimeInNanos)
            );
            messageFields.put("coordinator_post_fetch_time_millis", TimeUnit.NANOSECONDS.toMillis(Math.max(0L, coordinatorPostFetchTimeInNanos)));
        ...
        private static String message(SearchPhaseContext context, long tookInNanos, SearchRequestContext searchRequestContext) {
            ...
            sb.append("coordinator_execution_time_millis[")
                ...
                .append("], ");
            sb.append("coordinator_query_reduce_and_fetch_plan_millis[")
                .append(TimeUnit.NANOSECONDS.toMillis(coordinatorQueryReduceAndFetchPlanTimeInNanos))
                .append("], ");
            sb.append("coordinator_post_fetch_time_millis[")
                .append(TimeUnit.NANOSECONDS.toMillis(Math.max(0L, coordinatorPostFetchTimeInNanos)))
                .append("], ");
